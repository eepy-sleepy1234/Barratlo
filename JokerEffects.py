...
TAROT_REGISTRY = {
    'Chariot':'Enhances [orange]1[/orange] selected card into a [orange]Steel card[/orange]',
    'Death':'Select [orange]2[/orange] cards. Convert the [orange]left card[/orange] into the [orange]right card[/orange]{break}[grey](drag to rearrange)[/grey]',
    'Devil':'Enhances [orange]1[/orange] selected card into a [orange]Gold card[/orange]',
    'Emperor':'Creates up to [orange]2[/orange] random [purple]tarot[/purple] cards{break}[grey](must have room)[/grey]',
    'Empress':'Enhances [orange]2[/orange] selected cards into [orange]Mult[/orange] cards',
    'Fool':'Creates the last [purple]Tarot[/purple] or [teal]Planet[/teal] card used during this run{break}[purple]Fool[/purple] excluded{break}[grey]Currently {value}[/grey]',
    'Hanged Man':'Destroys up to [orange]2[/orange] selected cards',
    'Hermit':'Doubles money{break}[grey](Max of [/grey][yellow]$20[/yellow][grey])[/grey]',
    'Hierophant':'Enhances [orange]2[/orange] selected cards into [orange]Bonus cards[/orange]',
    'High Priest':'Creates up to [orange]2[/orange] random [teal]planet[/teal] cards{break}[grey](must have room)[/grey]',
    'Judgement':'Creates a random [orange]Joker[/orange] card{break}[grey](Must have room)[/grey]',
    'Justice':'Enhances [orange]1[/orange] selected card into a [orange]Glass card[/orange]',
    'Lovers':'Enhances [orange]1[/orange] selected card into a [orange]Wild card[/orange]',
    'Magician':'Enhances [orange]2[/orange] selected cards into [orange]Lucky cards[/orange]',
    'Moon':'Converts [orange]3[/orange] selected cards to [blue]Clubs[/blue]',
    'Star':'Converts [orange]3[/orange] selected cards to [orange]Diamonds[/orange]',
    'Strength':'Increases rank of [orange]2[/orange] selected cards by [orange]1[/orange]',
    'Sun':'Converts [orange]3[/orange] selected cards to [red]Hearts[/red]',
    'Temperance':'Gives the total sell value of all current [orange]Jokers[/orange] [grey](Max of [/grey][yellow]$50[/yellow][grey]){break}(Currently [/grey][yellow]${value}[/yellow][grey])[/grey]',
    'The Soul':'Creates a [yellow]Legendary[/yellow] [orange]Joker[/orange]{break}[grey](Must have room)[/grey]',
    'Tower':'Enhances [orange]1[/orange] selected card into a [orange]Glitched card[/orange]',
    'Wheel Of Fortune':'[green]{value1} in {value2}[/green] chance to add Foil, Holographic, or Polychrome edition to a random [orange]Joker[/orange]',
    'World':'Converts [orange]3[/orange] selected cards to [purple]Spades[/purple]',
}

SPECTRAL_REGISTRY = {
    'Ankh': 'Creates a copy of one random [orange]Joker[/orange]{break}destroys all other [orange]Jokers[/orange]',
    'Aura': 'Adds Foil, Holographic, or Polychrome edition to [orange]1[/orange] selected card',
    'Cryptid': 'Creates [orange]2[/orange] copies of [orange]1[/orange] selected card',
    'Deja Vu': 'Adds a red seal to [orange]1[/orange] selected card',
    'Ectoplasm': 'Adds Negative edition to [orange]1[/orange] random [orange]Joker[/orange]{break}[red]-1[/red] hand size',
    'Familiar': 'Destroys [orange]1[/orange] random card and creates [orange]3[/orange] random [orange]Enhanced face cards[/orange] to your hand',
    'Grim': 'Destroys [orange]1[/orange] random card and creates [orange]2[/orange] random [orange]Enhanced aces[/orange] to your hand',
    'Hex': 'Adds Polychrome to [orange]1[/orange] random [orange]Joker[/orange]{break}destroys all other [orange]Jokers[/orange]',
    'Immolate': 'Destroys [orange]5[/orange] random cards in hand{break}gives [yellow]$20[/yellow]',
    'Incantation': 'Destroys [orange]1[/orange] random card and creates [orange]4[/orange] random [orange]Enhanced numbered cards[/orange] to your hand',
    'Medium': 'Adds a [purple]Purple seal[/purple] to [orange]1[/orange] selected card',
    'Ouija': 'Converts all cards held in hand to a single random [orange]rank[/orange]{break}[red]-1[/red] hand size',
    'Sigil': 'Converts all cards held in hand to a single random [orange]suit[/orange]',
    'Talisman': 'Adds a [yellow]Gold seal[/yellow] to [orange]1[/orange] selected card',
    'Trance': 'Adds a [blue]Blue seal[/blue] to [orange]1[/orange] selected card',
    'Wraith': 'Creates a random [red]Rare[/red] [orange]Joker[/orange]{break}sets money to [yellow]$0[/yellow]',
    'The Soul': 'Creates a [yellow]Legendary[/yellow] [orange]Joker[/orange]{break}[grey](Must have room)[/grey]',
    'True Shadow': 'Upgrade every [purple]Poker hand[/purple] by [orange]1[/orange] level',
}

SHADOW_REGISTRY = {
    'Big': '(lvl. {value}) Level up [orange]Flush[/orange]{break}[red]+2[/red] Mult{break}[blue]+15[/blue] Chips',
    'Fists': '(lvl. {value}) Level up [orange]Four of a Kind[/orange]{break}[red]+3[/red] Mult{break}[blue]+30[/blue] Chips',
    'Glitch': '(lvl. {value}) Level up [orange]Huh of a What?[/orange]{break}[red]+4[/red] Mult{break}[blue]+50[/blue] Chips',
    'Ice': '(lvl. {value}) Level up [orange]Two Pair[/orange]{break}[red]+1[/red] Mult{break}[blue]+20[/blue] Chips',
    'King Shadow': '(lvl. {value}) Level up [orange]Flush Five[/orange]{break}[red]+3[/red] Mult{break}[blue]+50[/blue] Chips',
    'Quick': '(lvl. {value}) Level up [orange]Pair[/orange]{break}[red]+1[/red] Mult{break}[blue]+15[/blue] Chips',
    'Shadow': '(lvl. {value}) Level up [orange]Full House[/orange]{break}[red]+2[/red] Mult{break}[blue]+25[/blue] Chips',
    'Shadowbot': '(lvl. {value}) Level up [orange]Straight Flush[/orange]{break}[red]+4[/red] Mult{break}[blue]+40[/blue] Chips',
    'Stretch': '(lvl. {value}) Level up [orange]Straight[/orange]{break}[red]+3[/red] Mult{break}[blue]+30[/blue] Chips',
    'Tag Team': '(lvl. {value}) Level up [orange]Flush House[/orange]{break}[red]+4[/red] Mult{break}[blue]+40[/blue] Chips',
    'The Doctor': '(lvl. {value}) Level up [orange]High Card[/orange]{break}[red]+1[/red] Mult{break}[blue]+10[/blue] Chips',
    'The Reaper': '(lvl. {value}) Level up [orange]Five of a Kind[/orange]{break}[red]+3[/red] Mult{break}[blue]+35[/blue] Chips',
    'Trick': '(lvl. {value}) Level up [orange]Three of a Kind[/orange]{break}[red]+2[/red] Mult{break}[blue]+20[/blue] Chips',
    'True Shadow': 'Upgrade every [purple]Poker hand[/purple] by [orange]1[/orange] level',
}
